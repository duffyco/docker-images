#!/bin/bash
  ...
  #install Mootools
  rm -rf /usr/share/zoneminder/www/tools/
  ln -s /usr/share/javascript/mootools .
  ln -s /usr/share/javascript/mootools/mootools-core.min.js /usr/share/javascript/mootools/mootools-core.js
